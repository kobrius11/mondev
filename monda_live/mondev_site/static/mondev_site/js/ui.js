...
async function monda_uncollapse(obj_id) {
    ...
    if (data.state == 1) {
        var collapsible = document.getElementById(obj_id + "-content");
        var collapse_button = document.getElementById(obj_id + "-collapse");
        var uncollapse_button = document.getElementById(obj_id + "-uncollapse");
